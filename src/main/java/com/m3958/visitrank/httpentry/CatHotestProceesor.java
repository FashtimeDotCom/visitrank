...
public class CatHotestProceesor {
  ...
  public CatHotestProceesor(EventBus eb, HttpServerRequest req, Logger log) {
    this.eb = eb;
    this.req = req;
    this.log = log;
  }
  ...
  public void process() {
    ...
    JsonObject msg = new GET(siteid + catid + AppConstants.HOTEST_FIX).getCmd();
